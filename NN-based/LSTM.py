...
# torch.save(X_test, "x_test_masked_sum.pt")
# torch.save(y_test, "y_test_masked_sum.pt")
...
# torch.save(X_train, "x_train_masked_sum.pt")
# torch.save(y_train, "y_train_masked_sum.pt")
...
# torch.save(X_valid, "x_valid_masked_sum.pt")
# torch.save(y_valid, "y_valid_masked_sum.pt")
